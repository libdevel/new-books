...
$analyticspath = "SUNY%20Broome%20Community%20College%2001SUNY_BCC/Reports/New%20Books/display-elec-titles-for-rss-by-mms";
...
<rss version="2.0">
<channel>
	<title>SUNY Broome Library New Electronic Books On Display</title>
	<link>http://www.sunybroome.edu/library/</link>
	<description>SUNY Broome Library Book Feed : New electronic books on display</description>
<image>
...
//		$url = (string) $row->Column7;
		$publication_date = (string) $row->Column5;
...
<item>
  ...
  <pubDate><?php echo "date"; echo $publication_date;  ?></pubDate>
